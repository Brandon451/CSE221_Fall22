...
int benchmark_ctxsw(int cores, int iterations, bool warmup, int overheads)
{
    pid_t pid;
...
int benchmark_pthreads_ctxsw(int iterations, bool warmup, int overheads)
{
...
int main(int argc, char **argv)
{
    ...
    if (argc == 2)
    {
        ...
        {
            //warmup
            benchmark_ctxsw(1, 10, true, 0);
            //main benchmark
            return benchmark_ctxsw(1, 1000000, false, 450);
        }
        if (strcmp(argv[1], "kernel_thread") == 0)
        {
            //warmup
            benchmark_pthreads_ctxsw(10, true, 0);
            //main benchmark
            return benchmark_pthreads_ctxsw(1000000, false, 450);
        }
