##Uncomment each line to run different measurements
...
#./bin/context_switch kernel_thread >> part1_results/thread_context_switch.txt
#./bin/context_switch process kernel_thread >> part1_results/thread_context_switch.txt
